...
public class JSONArrayParseTestParameterized extends TestCase {
    ...
    public static Collection<Object[]> getParameters() {
        return Arrays.asList(new Object[][] {
                ...
                {"[{id:123}, {}]", new TypeReference<List<Map<String, Integer>>>() {}, Feature.OrderedField},

                {null, new TypeReference<List<Map<String, Integer>>>() {}, Feature.OrderedField},
                {"", new TypeReference<List<Map<String, Integer>>>() {}, Feature.OrderedField}
        });
    }
